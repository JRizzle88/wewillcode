        	...
        	<div class="card grey lighten-5">
              <div class="card-content">
                  ...
                  <div class="card-action">
                    ...
                    <a href="{{ url('superadmin/posts') }}" class="btn btn-small waves-effect waves-light white-text blue right"><i class="fa fa-eye"></i></a>
                  </div>
              </div>
          </div>
      </div>
        	...
        	<div class="card grey lighten-5">
              <div class="card-content">
                  ...
                  <div class="card-action">
                    ...
                    <a href="{{ url('superadmin/pages') }}" class="btn btn-small waves-effect waves-light white-text blue right"><i class="fa fa-eye"></i></a>
                  </div>
              </div>
          </div>
      </div>
