	...
	<div class="container">
		<div class="card grey lighten-5">
			<div class="card-content">
				<span class="card-title">SIDEBARS</span>
				<div class="row">
					<div class="col s12 m5 l5">
						{!! Form::model(new App\Sidebar, ['route' => ['superadmin.sidebars.store']]) !!}
							@include('superadmin/sidebars/partials/_form', ['submit_text' => 'Create Sidebar'])
						{!! Form::close() !!}
					</div>
